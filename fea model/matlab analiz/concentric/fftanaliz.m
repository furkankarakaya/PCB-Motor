...
time_array = Timems - Timems(1);
Tstep = (time_array(2) - time_array(1))*1e-03;
time_array2 = transpose(0:Tstep:100.45e-3); % 45 ms of data is taken

% Vdc1 - Rectifier - No int

% InducedVoltagePhaseA = lowpass(InducedVoltagePhaseA,Tstep,filter_freq);
...
figure;
hold all;
plot(InducedVoltagePhaseA_FFTDATA.freq,InducedVoltagePhaseA_FFTDATA.mag,'bo-','Linewidth',1);
