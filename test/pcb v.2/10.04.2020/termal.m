...
uew=[ 19.3 22  25.4 27.8 28.5 29.1 29.6 30 30.4 30.5 30.6 30.7 30.7 30.8 30.9 31 31 31.3 31.4 31.4 31.5 31.6 31.6 31.7 31.7 31.8 31.9 31.9 32 32 32 ];
...
figure;
hold all;
x=[test_con_freq(1:187)./266.67 test_rad_freq(1:187)./266.67 test_arc_freq(1:187)./266.67 test_par_freq(1:187)./266.67 test_uew_freq(1:187)./266.67];
y=[test_con_fft(1:187) test_rad_fft(1:187) test_arc_fft(1:187) test_par_fft(1:187) test_uew_fft(1:187)];
bar(x,y);
xlabel('Harmonic Components','FontSize',40,'FontWeight','Bold')
ylabel('Magnitude of Induced Voltage (V)','FontSize',40,'FontWeight','Bold')
legend('Concentric','Radial','Arc','Parallel','UEW');
grid on
xlim([0.5 3.5]);
ylim([0 10]);
%%
...
figure;
hold all;
plot((conc_time-0.00062)*1000,-conc);
plot((rad_time-0.00062)*1000,-rad);
plot((arc_time+0.00064)*1000,-arc);
plot((par_time+0.00064)*1000,-par);
plot((uew_time+0.00064)*1000,-uew,'.-.');
xlabel('Time (ms)','FontSize',40,'FontWeight','Bold')
ylabel('Magnitude of Induced Voltage (V)','FontSize',40,'FontWeight','Bold')
legend('Concentric','Radial','Arc','Parallel','UEW');
grid on
