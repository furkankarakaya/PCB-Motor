 function obj = obj_single_sided(x)
...
g_magnetic = g_cl+g_pcb_overall;    %m, magnetic air gap
...
b_square = (l_mag*br) / (ur * g_magnetic + l_mag);  %T, leakageler ignore edildiðinde kare flux density'nin tepesi
...
m_mag = vol_per_mag*p*dens_mag;   %kg, total magnet mass, p tane
